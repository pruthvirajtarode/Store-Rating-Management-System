    ...
    <div className="min-h-screen flex bg-gray-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-16 text-white h-full pb-24">
          <h2 className="text-4xl font-bold mb-4 tracking-tight leading-tight">Welcome to RateHub</h2>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input type="email" required
                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-gray-900"
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} required
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all pr-12 text-gray-900"
